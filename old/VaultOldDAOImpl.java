...
@Repository
@Transactional
public class VaultOldDAOImpl implements VaultOldDAO {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(VaultOldDAOImpl.class);

    private final EntityManager em;

    public VaultOldDAOImpl(EntityManager em){
        this.em = em;
    }
