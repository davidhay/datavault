...
public class PendingOLDVaultCustomDAOImpl extends BaseCustomDAOImpl implements
    PendingOLDVaultCustomDAO {

    public PendingOLDVaultCustomDAOImpl(EntityManager em) {
        super(em);
    }
